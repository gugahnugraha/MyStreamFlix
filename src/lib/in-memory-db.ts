...
const defaultLiveTvChannels: Movie[] = [
  ...
  {
    id: "tv-cnn-indonesia",
    title: "CNN Indonesia Live",
    description: "Siaran berita 24 jam nonstop menyajikan liputan mendalam, fakta terkini, politik, ekonomi, dan peristiwa nasional maupun internasional.",
    posterUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/CNN_Indonesia_2015.svg/960px-CNN_Indonesia_2015.svg.png",
    backdropUrl: "https://images.unsplash.com/photo-1585829365295-ab7cd400c167?w=1200&auto=format&fit=crop&q=80",
    videoUrl: "https://live.cnnindonesia.com/livecnn/smil:cnntv.smil/playlist.m3u8",
    duration: 0,
    releaseYear: 2026,
    rating: 9.5,
    ageRating: "SU",
    quality: "Full HD",
    genres: ["News"],
    cast: ["News Anchor CNN Indonesia", "Tim Redaksi CNN"],
    directors: ["Trans Media & Warner Bros. Discovery"],
    subtitles: [],
    country: "Indonesia",
    language: "id",
    views: 312000,
  ...
  },
  {
    id: "tv-sctv-live",
    title: "SCTV Live",
    description: "Siaran langsung SCTV - Surya Citra Televisi menyajikan Sinetron unggulan, FTV, Liputan 6 Berita, dan siaran langsung olahraga.",
    posterUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/SCTV_2005.svg/960px-SCTV_2005.svg.png",
    backdropUrl: "https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?w=1200&auto=format&fit=crop&q=80",
    videoUrl: "https://cdnbal1.indihometv.com/atm/DASH/sctv/sctv.mpd",
    duration: 0,
    releaseYear: 2026,
    rating: 9.4,
    ageRating: "R13",
    ...
    cast: ["Presenter Liputan 6", "Artis Sinetron SCTV"],
    directors: ["Surya Citra Media (SCM)"],
    subtitles: [],
    country: "Indonesia",
    language: "id",
    views: 298000,
  ...
  },
  {
    id: "tv-inews-live",
    title: "iNews TV Live",
    description: "Stasiun televisi berita, olahraga, dan informasi nasional 24 jam menyajikan iNews Prime, iNews Room, dan program olahraga terdepan.",
    posterUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/INews_2015.svg/960px-INews_2015.svg.png",
    backdropUrl: "https://images.unsplash.com/photo-1585829365295-ab7cd400c167?w=1200&auto=format&fit=crop&q=80",
    videoUrl: "https://cdnbal1.indihometv.com/atm/DASH/inews/inews.mpd",
    duration: 0,
    releaseYear: 2026,
    rating: 9.3,
    ageRating: "SU",
    quality: "Full HD",
    genres: ["News", "Sports"],
    cast: ["News Anchor iNews", "Tim Redaksi MNC Media"],
    directors: ["MNC Media"],
    subtitles: [],
    country: "Indonesia",
    language: "id",
